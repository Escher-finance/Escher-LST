...
type InstantiateMsg struct {
	UnderlyingCoinDenom *string `json:"underlying_coin_denom,omitempty"`
	LiquidstakingDenom *string `json:"liquidstaking_denom,omitempty"`
	Ucs01Channel *string `json:"ucs01_channel,omitempty"`
	Ucs01RelayContract *string `json:"ucs01_relay_contract,omitempty"`
	FeeRate float64  `json:"fee_rate,omitempty"`
	RevenueReceiver *string  `json:"revenue_receiver,omitempty"`
	UnbondingTime uint64  `json:"unbonding_time,omitempty"`
	Cw20Address *string  `json:"cw20_address,omitempty"`
	Validators Validator `json:"cw20_address,omitempty"`
}
