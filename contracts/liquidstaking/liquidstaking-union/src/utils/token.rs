use cosmwasm_std::{to_json_binary, Addr, Binary, CosmosMsg, StdResult, SubMsg, Uint128, WasmMsg};
...
pub fn burn_token(amount: Uint128, cw20_address: String) -> StdResult<CosmosMsg> {
    let execute_burn = cw20::Cw20ExecuteMsg::Burn { amount };
    let burn_bin = to_json_binary(&execute_burn)?;
