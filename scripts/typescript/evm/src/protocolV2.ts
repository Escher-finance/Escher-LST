...
import { Address, bytesToHex, encodeAbiParameters, encodeFunctionData, encodePacked, Hex, parseAbi, fromHex, toHex, keccak256 } from "viem";
...
const U_TO_UNION_SOLVER_METADATA_TESTNET = "";
...
export const predictWrappedTokenV2 = async (signer: ethers.Wallet, channelId: bigint, baseToken: string) => {
    ...
    let res = await ucs03Contract.predictWrappedTokenV2(0n, channelId, baseToken, metadata);
    console.log("res", res);
}
...
export const getAddressFromEvm = Effect.fn(
    function* (params: GetAddressFromEvmParams) {
