...
contract Handler is Test {
    ...
    function hedgingLoop(
        ...
        (uint256 iterations, bool isEnough, uint256 totalBorrowed, uint256 ltvUsed) = IlSolverMath.hedgingLoop(collateralAmount, borrowedAmount, borrowAmountUSD, ltv);
    ...
    function calculateCollateralAmount(
        ...
        (uint256 iterations, bool isEnough, uint256 totalBorrowed, uint256 ltvUsed) = IlSolverMath.hedgingLoop(collateral, borrowedAmount, borrowAmountUSD, ltv);
        assertEq(isEnough, true);
    }
}